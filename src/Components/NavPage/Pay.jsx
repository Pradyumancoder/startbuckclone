    ...
    <div>
      ...
      <div className='h-fit w-[100%] mt-5'>
        <div className='h-[50px] w-[80%] justify-between bg-[#B2D396] flex gap-5 m-auto'>
          <button className='text-[16px] leading-[19px] text-[#1e3932] font-medium'>
            My Starbucks Cards
          </button>
          <div className='gap-3 flex text-center'>
            <button className='font-medium text-[13px] leading-[15px] text-[#00754a]'>
              My Starbucks Cards
            </button>
          ...
          <div className='flex m-auto gap-8 h-[250px] w-[800px] p-5 cursor-pointer'>
            <div className='h-[300px] w-[325px] bg-slate-100'>
              ...
              <div className='h-5 flex gap-[150px] cursor-pointer mt-3'>
                <h5 className='text-[10px] leading-[12px] font-medium text-[#BDBDBD]'>
                  Updated at 02.650 15/06/23
                </h5>

                <span className='flex gap-2 '>
                  <img
                    src='https://www.starbucks.in/assets/icon/Maskrefresh.svg'
                    alt='refres-icon'
                  />
                  <img
                    src='https://www.starbucks.in/assets/icon/Masksetting.svg'
                    alt='Setting-icon'
                  />
                </span>
              </div>
            ...
            <div className='h-[300px] w-[325px] border border-white bg-slate-100 relative cursor-pointer'>
              <img
                src='https://www.starbucks.in/assets/images/bg_pattern.svg'
                alt='second-img-with-background'
              />
              <div className='absolute inset-0 flex flex-col justify-center items-center '>
                ...
                <span className='flex justify-center items-center bg-black w-[110px] rounded-md'>
                  <img
                    src='https://www.starbucks.in/assets/icon/add_circle_darkened_green.svg'
                    alt='add-card-icon'
                  />
